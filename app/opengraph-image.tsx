    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Captures enquiries in the patient&rsquo;s own language, holds a real slot, and tells the team
            who to call first.
          </div>
        </div>

        <div style={{ display: "flex", gap: 14, fontFamily: "sans-serif", fontSize: 22 }}>
          {["Gujarati · Hinglish · English", "n8n + Gemini + ElevenLabs", "Holds slots, never confirms"].map(
            (t) => (
              <div
                key={t}
                style={{
